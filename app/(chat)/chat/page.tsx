    ...
    <div className="relative min-h-screen">
      ...
      <div className="pt-20 flex flex-col justify-center">
        ...
        <form className="mx-auto py-6 flex gap-4">
          <input className="w-[500px] h-[50px] px-5 bg-slate-200 outline-none text-gray-800 text-lg font-medium rounded-3xl border-2 shadow-2xl border-primary" type="text" name="" id="" />
